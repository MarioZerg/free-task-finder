...
const items = [
  ...
  },
  {
    ...
    a: 'Сумму назначает заказчик по итогу работы — в объявлении она лишь ориентир. Ограничение одно: до 1500 ₽ за разовую задачу. Это работа на пару часов или на день: погрузка, уборка, сборка мебели, помощь на участке, мелкий ремонт. Сам сервис бесплатный, комиссий нет.',
  },
  {
