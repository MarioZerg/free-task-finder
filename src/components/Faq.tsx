...
const items = [
  ...
  },
  {
    ...
    a: 'Да. Публикация объявлений, отклики и подтверждение исполнителя не стоят ничего. Комиссии с оплаты мы не берём — заказчик и исполнитель рассчитываются напрямую. Отдельно есть необязательная подписка «Доделай PRO» за 990 ₽ в месяц: она снимает лимит на количество заданий и даёт поднимать объявление чаще. Без неё сервис работает в полном базовом объёме.',
  },
  {
