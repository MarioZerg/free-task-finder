...
const items = [
  ...
  },
  {
    ...
    a: 'Сервис рассчитан на небольшие разовые задачи: оплата в объявлениях — от 500 до 1500 ₽. Это работа на пару часов или на день: погрузка, уборка, сборка мебели, помощь на участке, мелкий ремонт.',
  },
  {
