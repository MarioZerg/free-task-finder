...
const steps: Record<Role, { icon: string; title: string; text: string }[]> = {
  customer: [
    ...
    { icon: 'Users', title: 'Отклики', text: 'Исполнители рядом видят заказ в общей ленте и откликаются.' },
  ...
  executor: [
    ...
    { icon: 'ListFilter', title: 'Лента рядом', text: 'Фильтры по категории и поиску — только нужные заказы.' },
