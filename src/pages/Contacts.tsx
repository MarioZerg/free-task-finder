...
const Contacts = () => {
  useSeo({
    ...
    description:
      'Как связаться с сервисом Доделай.ру: почта поддержки support@dodelay.ru, реквизиты ИП, регион работы и время ответа. Отвечаем с 9:00 до 21:00 в течение рабочего дня.',
        ...
        <section className="mt-6 rounded-3xl border border-line bg-surface p-6 md:p-8">
          ...
          <ul className="mt-4 space-y-3">
            {[
              ...
              'Подписка «Доделай PRO» — 2000 ₽ в месяц, оплата через интернет-эквайринг Точка Банк.',
            ].map((t) => (
